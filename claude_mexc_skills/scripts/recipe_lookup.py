...
RECIPES = {
    "spot": ROOT / ".claude" / "skills" / "mexc-spot-rest" / "references" / "recipes.md",
    "futures": ROOT / ".claude" / "skills" / "mexc-futures-rest" / "references" / "recipes.md",
}
HELPERS = {
    "spot": "python .claude/skills/mexc-spot-rest/scripts/mexc_spot_request.py",
    "futures": "python .claude/skills/mexc-futures-rest/scripts/mexc_futures_request.py",
}
SECTION_ALIASES = {
    "spot": {
