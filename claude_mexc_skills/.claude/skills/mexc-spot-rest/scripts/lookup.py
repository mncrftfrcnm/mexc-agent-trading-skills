#!/usr/bin/env python3
"""Print one local MEXC Spot REST recipe/reference slice."""
...
HELPER = Path(__file__).resolve().with_name("mexc_spot_request.py")
...
SECTION_ALIASES = {
    ...
    "Rebates And Affiliate": "rebate affiliate refer commission tax subaffiliate",
}
...
def main() -> int:
    ...
    print(f"No Spot REST recipe matched: {query}")
    return 1
